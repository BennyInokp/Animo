export default function FeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      title: "Stream Skill Acquisition",
      description: " Learn Top high income skills and be your own boss. Stream is designed to equip you with high-demand skills for the future."
    },
    {
      icon: (
        <svg className="w-16 h-16 text-[#B8E68C]" fill="currentColor" viewBox="0 0 24 24">
      ...
      title: "Stream Bazar",
      description: "Stream Bazar - sell your products, buy and promote ur business inside stream Africa."
    },
    {
      icon: (
        <svg className="w-16 h-16 text-[#B8E68C]" fill="currentColor" viewBox="0 0 24 24">
      ...
      title: "What you can do in stream",
      description: " collaboration- listen to songs and get $1.5 (N1550) in a few minutes."
    },
    {
      icon: (
        <svg className="w-16 h-16 text-[#B8E68C]" fill="currentColor" viewBox="0 0 24 24">
      ...
      description: "Stream Networking Platform is more than an earning platform; it's an ecosystem built to foster personal and financial evolution."
    }
  ];
