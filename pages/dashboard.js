...
// //       <h1 className="text-5xl text-white font-bold mb-8">Dashboard</h1>
// //       <p className="text-white text-xl">Welcome to your Animo dashboard!</p>
...
//  const openWhatsApp = () => {
//   window.open("https://wa.me/2349130803772", "_blank");
// };

// const openTelegram = () => {
//   window.open("https://t.me/HidomTV", "_blank");
// };
...
//   return (
//     <div className="mt-10 text-white justify-center px-[25rem] bg-gray-900">
//       {copyMessage && (
//         <div className="fixed top-28 left-1/2 -translate-x-1/2 bg-white text-black px-6 py-2 rounded-xl shadow-lg z-50 font-bold">
//           Copied!
//         </div>
//       )}

//       <h2 className="text-3xl font-bold text-center mb-2">Complete Payment</h2>
//       <p className="text-gray-400 text-center mb-6">Secure Transfer Gateway</p>

//       <div className="bg-[#030712] p-5 rounded-xl">
...
//                   fontSize: item.label === "TOTAL AMOUNT" ? "1.5rem" : "1.1rem",
...
//               <button onClick={() => handleCopy(item.value)} className="text-green-400">
//                 <FiCopy size={20} />
//               </button>
//             </div>
//           </div>
...
//           className="flex-1 flex items-center justify-center gap-2 bg-green-700 hover:bg-green-800 transition p-3 rounded-lg mb-8 font-bold"
//         >
//           <FaWhatsapp size={18} />
//           Please Proceed
//         </button>
...
//           className="flex-1 flex items-center justify-center gap-2 bg-[#06374f] hover:bg-[#085f7b] transition p-3 rounded-lg mb-8 font-bold"
//         >
...
export default function Dashboard() {
  ...
  const openWhatsApp = () => {
    window.open("https://wa.me/2349130803772?text=Hello%2C%20I%20am%20interested%20in%20Animo", "_blank");
  };
    ...
    <div className="min-h-screen pt-20 sm:pt-24 pb-8 sm:pb-12 px-4 sm:px-6 md:px-8 lg:px-12 bg-gray-900">
      <div className="max-w-3xl mx-auto text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-12">
          <button
            onClick={openWhatsApp}
            className="flex items-center justify-center gap-2 bg-green-700 hover:bg-green-800 transition p-3 sm:p-3.5 rounded-lg font-bold text-sm sm:text-base"
          >
